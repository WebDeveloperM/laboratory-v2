...
# Haqiqiy kalit .env faylda turadi va git'ga tushmaydi. Quyidagi zaxira qiymat faqat
# lokal ishga tushirish uchun — serverda SECRET_KEY albatta .env da belgilanishi shart.
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-local-dev-only-set-SECRET_KEY-in-env')
